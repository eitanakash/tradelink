  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-blue-900 flex flex-col items-center justify-center px-4">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-blue-200">{t('landing.tagline')}</p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-6 w-full max-w-lg">
        ...
        >
          ...
          <span className="text-lg font-semibold text-white">{t('landing.needService')}</span>
          <span className="text-sm text-blue-200 group-hover:text-white transition-colors">
            {t('landing.needServiceSub')}
          </span>
        </button>
        ...
        >
          <span className="text-5xl">🔧</span>
          <span className="text-lg font-semibold text-white">{t('landing.isContractor')}</span>
          <span className="text-sm text-blue-200 group-hover:text-white transition-colors">
            {t('landing.isContractorSub')}
          </span>
        </button>
      </div>

      <p className="mt-8 text-sm text-blue-300">{t('landing.addRoleLater')}</p>

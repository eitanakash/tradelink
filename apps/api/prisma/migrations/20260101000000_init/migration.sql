-- CreateEnum
CREATE TYPE IF NOT EXISTS "Role" AS ENUM ('CLIENT', 'CONTRACTOR');
CREATE TYPE IF NOT EXISTS "JobStatus" AS ENUM ('OPEN', 'IN_REVIEW', 'AWARDED', 'COMPLETED', 'CANCELLED');
CREATE TYPE IF NOT EXISTS "QuoteStatus" AS ENUM ('PENDING', 'ACCEPTED', 'REJECTED');
CREATE TYPE IF NOT EXISTS "ServiceAreaType" AS ENUM ('CITY', 'REGION', 'RADIUS');
CREATE TYPE IF NOT EXISTS "FileCategory" AS ENUM ('JOB_PHOTO', 'JOB_VIDEO', 'JOB_DOCUMENT', 'QUOTE_PHOTO', 'QUOTE_DOCUMENT', 'PROFILE_PHOTO', 'PROFILE_DOCUMENT');
CREATE TYPE IF NOT EXISTS "MessageType" AS ENUM ('TEXT', 'FILE', 'SYSTEM');
CREATE TYPE IF NOT EXISTS "NotificationType" AS ENUM ('NEW_QUOTE', 'QUOTE_ACCEPTED', 'QUOTE_REJECTED', 'NEW_MESSAGE', 'JOB_AWARDED', 'JOB_COMPLETED', 'QUESTION_ANSWERED', 'NEW_JOB_IN_AREA');
CREATE TYPE IF NOT EXISTS "DisputeStatus" AS ENUM ('OPEN', 'UNDER_REVIEW', 'RESOLVED', 'CLOSED');
